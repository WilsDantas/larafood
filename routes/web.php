...
Route::prefix('admin')
     ...
     */
    Route::get('product/{id}/category/{idCategory}/detach', 'CategoryProductController@detachCategoriesProduct')->name('products.category.detach');
    Route::post('product/{id}/categories', 'CategoryProductController@attachcategoriesProduct')->name('products.categories.attach');
    ...
    Route::get('categories/{id}/product', 'CategoryProductController@product')->name('categories.products');
     ...
     */
    Route::get('profile/{id}/permission/{idPermission}/detach', 'ACL\PermissionProfileController@detachPermissionsProfile')->name('profile.permissions.detach');
    Route::post('profile/{id}/permission', 'ACL\PermissionProfileController@attachPermissionsProfile')->name('profile.permissions.attach');
    Route::any('profile/{id}/permission/create', 'ACL\PermissionProfileController@permissionsAvailable')->name('profile.permissions.available');
    Route::get('profile/{id}/permission', 'ACL\PermissionProfileController@permissions')->name('profile.permissions');
...
//Auth::Routes(['register' => false]); Desabilita Registros